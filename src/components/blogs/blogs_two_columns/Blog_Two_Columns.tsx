        ...
        <div className="wrapper">
            <header className="Header_Blog_Two">
                <div className="Navigation">
                    <div className="First">
                    <Link to="/home"><img src="src/components/blogs/blogs_two_columns/img/Logo.png" alt="Logo" className="Logo"/></Link>
            ...
            <div className="Recent_Post_Blog_Two_Columns_First">
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_First.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_First.png" alt="Avatar" />
                ...
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_Second.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_Second.png" alt="Avatar" />
            ...
            <div className="Recent_Post_Blog_Two_Columns">
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_Third.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_Third.png" alt="Avatar" />
                ...
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_Fourth.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_Fourth.png" alt="Avatar" />
            ...
            <div className="Recent_Post_Blog_Two_Columns_Last">
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_Fifth.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_Fifth.png" alt="Avatar" />
                ...
                <div className="Blog_Two_Columns">
                    <div className="Foto_Blog_Two_Columns">
                        <img src="src/components/blogs/blogs_two_columns/img/Feature_Sixth.png" alt="Food"/>
                        <button className="Fashion">Fashion</button>
                    </div>
                    <div className="Review_Two_Columns">
                        <div className="User_Two_Columns">
                            <img src="src/components/blogs/blogs_two_columns/img/Avatar_Sixth.png" alt="Avatar" />
            ...
            <footer className="footer">
                ...
                <div className="Contacts">
                    ...
                    <img src="src/components/blogs/blogs_two_columns/img/Social_Media.png" alt="Social Media" />
                </div>
            </footer>
        </div>
    )
